...
public class SimpleFavoriteTreeModel extends SimpleTreeModel
{
	 ...
	 * @param root
	 */
	public SimpleFavoriteTreeModel(DefaultTreeNode<MTreeNode> root)
	{
	    super(root);
	}
	...
	public static SimpleFavoriteTreeModel createFrom(MTreeNode root)
	{
		...
		DefaultTreeNode<MTreeNode> stRoot =
		        new DefaultTreeNode<MTreeNode>(root, new ArrayList<DefaultTreeNode<MTreeNode>>());
		...
		while (nodeEnum.hasMoreElements())
		{
			...
			DefaultTreeNode stNode = new DefaultTreeNode(childNode, new ArrayList<DefaultTreeNode<MTreeNode>>());
	...
	{
	    MTreeNode mtn = node.getData();

	    Treecell tc;
	    if (!mtn.isSummary())
	    {
	        tc = new Treecell(mtn.getName(), getIconFile(mtn));
	    }
	    else
	    {
	        tc = new Treecell(mtn.getName(), "images/dark/FolderPlain16.png");
	    }
	...
	public void renameNode(DefaultTreeNode simpleTreeNode, String newName) {
	...
	@Override
	public DefaultTreeNode<MTreeNode> getChild(org.zkoss.zul.TreeNode parent, int index) {

...
public class TreeUtils {
    ...
    public static void traverse(Treechildren treechildren, TreeItemAction action) {
        if (treechildren == null || action == null) {
            return;
        }
    ...
    public static void traverse(TreeModel model, TreeNodeAction action) {
        if (model == null || action == null || model.getRoot() == null) {
            return;
        }
     ...
     * @param action
     */
    public static void traverse(TreeModel model, Object parent, TreeNodeAction action) {
        if (model == null || parent == null || action == null) {
            return;
        }
